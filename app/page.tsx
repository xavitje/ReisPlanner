  ...
  return (
    <main className="relative min-h-screen w-full overflow-hidden bg-[var(--iceland-light-100)]">
      ...
      <div className="hidden lg:flex h-screen">
        ...
        <div className="w-[480px] h-full flex flex-col bg-gradient-to-br from-[var(--iceland-mid-200)] to-[var(--iceland-light-100)] border-r border-[var(--iceland-mid-300)] shadow-2xl">

          {/* Header */}
          <div className="p-8 pb-6 border-b border-[var(--iceland-mid-300)]">
                  ...
                  {trips.length > 0 ? (
                    trips.map((trip, index) => (
                      <motion.div
                        ...
                        className="route-card bg-white p-6 cursor-pointer border border-[var(--iceland-mid-300)] hover:shadow-xl"
                      >
                        {/* Time Display */}
      ...
      <div className="lg:hidden min-h-screen flex flex-col">
        {/* Mobile Header */}
        <div className="bg-gradient-to-br from-[var(--cherry-dark-1000)] to-[var(--cherry-mid-700)] p-6 pb-8 shadow-2xl rounded-b-[40px]">
          <div className="flex items-center gap-3 mb-6">
                ...
                {trips.length > 0 ? (
                  trips.map((trip, index) => (
                    <motion.div
                      ...
                      transition={{ delay: index * 0.05 }}
                      onClick={() => setSelectedTrip(trip)}
                      className="route-card bg-white p-5 cursor-pointer border border-[var(--iceland-mid-300)] shadow-lg"
                    >
                      ...
                      <div className="flex items-center justify-between bg-[var(--iceland-light-100)] p-3 rounded-2xl text-sm">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-semibold">{trip.duration} min</span>
                        </div>
                        <div className="flex items-center gap-2">
                  ...
                  !loading && (
                    <div className="text-center py-16">
                      ...
                      <p className="text-[var(--iceland-dark-1000)] opacity-60 px-6">
                        Vul een vertrekpunt en bestemming in om reizen te zoeken
                      </p>
                    </div>
                  )
